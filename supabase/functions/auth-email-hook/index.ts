...
// Configuration
const SITE_NAME = "ollowork"
const SENDER_DOMAIN = "notify.app.ollo.work"
const ROOT_DOMAIN = "app.ollo.work"
const FROM_DOMAIN = "app.ollo.work" // Domain shown in From address (may be root or sender subdomain)
