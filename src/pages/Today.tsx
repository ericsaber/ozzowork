...
const Today = () => {
  ...
  const renderComingUp = () => {
    ...
    return (
      <button onClick={() => navigate("/upcoming")} className="w-full bg-card rounded-lg p-4 flex items-center gap-3 hover:bg-secondary/50 transition-colors" style={{ boxShadow: "0 1px 5px rgba(0,0,0,.08)" }}>
        <div className="flex-1 min-w-0 text-left">
