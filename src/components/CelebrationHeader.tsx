    ...
    <>
      ...
      >
              ...
              style={
                isFirst
                  ? {
                      strokeDasharray: 30,
                      strokeDashoffset: 30,
                      animation: "ch-check-draw 300ms ease-out 280ms forwards",
                    }
                  : {}
              }
            >
              <path
                d="M5 13l4 4L19 7"
                stroke={isFirst ? "white" : "#bbb"}
                strokeWidth={isFirst ? 3 : 2.5}
                strokeLinecap="round"
        ...
        <div
          style={
            isFirst
              ? { animation: "ch-fade-up 300ms ease-out 150ms both" }
              : { animation: "ch-fade-up 300ms ease-out both" }
          }
        >
          {isFirst ? (
            <h2
              className="text-foreground"
              style={{ fontFamily: "var(--font-heading)", fontSize: 21, lineHeight: "26px" }}
            >
            ...
            <h2
              ...
              style={{ fontFamily: "var(--font-body)", fontSize: 18, lineHeight: "24px" }}
            >
              Done.
            </h2>
          )}
          <p
            ...
            style={{ fontFamily: "var(--font-body)", fontSize: 11, lineHeight: "16px" }}
          >
            {isFirst ? (
              <>
                Logging with{" "}
